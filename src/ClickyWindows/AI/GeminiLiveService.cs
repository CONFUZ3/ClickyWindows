...
public class GeminiLiveService : IRealtimeVoiceService
{
    ...
    // Gemini Live ingests microphone PCM at 16kHz (see SendAudioAsync's mimeType).
    public int InputSampleRateHz => 16000;
                                   ...
                                   CancellationToken token)
    {
        ...
        var setupObj = new JsonObject
        {
            ...
            ["generationConfig"] = new JsonObject
            {
                ...
                // Without this, Gemini Live processes screenshots at MEDIA_RESOLUTION_LOW
                // (~280 image tokens — thumbnail-grade), which causes the model to hallucinate
                // small UI text and miss buttons. HIGH = 1120 tokens — only ~840 extra tokens
                // per turn since we send exactly one screenshot per push-to-talk turn.
